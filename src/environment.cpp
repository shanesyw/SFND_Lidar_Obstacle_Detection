    ...
    const pcl::PointCloud<pcl::PointXYZI>::Ptr& inputCloud)
{
    ...
    //Downsample and crop out data points we don't use.
    pcl::PointCloud<pcl::PointXYZI>::Ptr filterCloud;
    filterCloud = pointProcessorI->FilterCloud(inputCloud, 0.2f ,
    ...
    std::pair<pcl::PointCloud<pcl::PointXYZI>::Ptr, pcl::PointCloud<pcl::PointXYZI>::Ptr> segmentCloud = 
        pointProcessorI->SegmentPlane(filterCloud, 50, 0.2);
    ...
    pointProcessorI->Clustering(segmentCloud.second, 0.4, 10, INT32_MAX);
